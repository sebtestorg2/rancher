...
func (p *Store) Create(apiContext *types.APIContext, schema *types.Schema, data map[string]interface{}) (map[string]interface{}, error) {
	...
	return p.legacyIngressProxyStore().Create(apiContext, schema, data)
}
...
func (p *Store) Update(apiContext *types.APIContext, schema *types.Schema, data map[string]interface{}, id string) (map[string]interface{}, error) {
	...
	// TODO: remove when support for k8s 1.18 is dropped
	return p.legacyIngressProxyStore().Update(apiContext, schema, data, id)
}
...
func (p *Store) List(apiContext *types.APIContext, schema *types.Schema, opt *types.QueryOptions) ([]map[string]interface{}, error) {
	...
	// TODO: remove when support for k8s 1.18 is dropped
	return p.legacyIngressProxyStore().List(apiContext, schema, opt)
}
...
func (p *Store) Watch(apiContext *types.APIContext, schema *types.Schema, opt *types.QueryOptions) (chan map[string]interface{}, error) {
	...
	// TODO: remove when support for k8s 1.18 is dropped
	return p.legacyIngressProxyStore().Watch(apiContext, schema, opt)
}
...
func (p *Store) ByID(apiContext *types.APIContext, schema *types.Schema, id string) (map[string]interface{}, error) {
	...
	// TODO: remove when support for k8s 1.18 is dropped
	return p.legacyIngressProxyStore().ByID(apiContext, schema, id)
}
...
// legacyIngressProxyStore returns a norman proxy store object for the
...
// TODO: remove when support for k8s 1.18 is dropped
func (p *Store) legacyIngressProxyStore() types.Store {
	return proxy.NewProxyStore(
		context.Background(),
		p.userContext.ClientGetter,
